...
export const getDateForET = (date: Date) => {
	return format.format(date);
};

export const tzOffsetMinutes = (at: Date,) => {
	const tzName = format
		.formatToParts(at)
...
export const dateStrToDateInTZ = (value: string) => {
...
export const epochToDateStrInTZ = (epochMs?: number|null) => {
...
export const dateStrToEpochMs = (value: string) => {
